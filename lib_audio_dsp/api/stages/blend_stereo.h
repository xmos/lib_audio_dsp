...
#include "blend_stereo_config.h" // Autogenerated
#include "bump_allocator.h"

typedef struct
{
    blend_stereo_config_t config;
    int n_inputs;
    int n_outputs;
    int frame_size;
    int32_t gains[2];
}blend_stereo_state_t;

#define BLEND_STEREO_STAGE_REQUIRED_MEMORY 0
...
void blend_stereo_control(void *state, module_control_t *control);
