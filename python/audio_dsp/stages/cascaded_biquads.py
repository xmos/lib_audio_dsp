...
class CascadedBiquads(Stage):
    def __init__(self, **kwargs):
        ...
        filter_spec = [['bypass'],
                  ...
                  ['bypass'],
                  ['bypass']]
        self.dsp_block = casc_bq.parametric_eq_8band(self.fs, filter_spec)
    ...
    def make_butterworth_highpass(self, N, fc):
        ...
        self.dsp_block = casc_bq.butterworth_highpass(self.fs, N, fc)
        return self
    
    def make_butterworth_lowpass(self, N, fc):
        self.details = dict(type="butterworth lowpass", N=N, fc=fc)
        self.dsp_block = casc_bq.butterworth_lowpass(self.fs, N, fc)
        return self
