...
class LimiterRMS(Stage):
    def __init__(self, **kwargs):
        ...
        self.set_control_field_cb(
            "attack_alpha", lambda: self.dsp_block.attack_alpha_f32
        )
        self.set_control_field_cb(
            "release_alpha", lambda: self.dsp_block.release_alpha_f32
        )
        self.set_control_field_cb("threshold", lambda: self.dsp_block.threshold_f32)

    def make_limiter_rms(
        self, threshold_db, attack_t, release_t, delay=0, Q_sig=dspg.Q_SIG
    ):
        """
