...
class NoiseSuppressor(Stage):
    def __init__(self, **kwargs):
        ...
        self.set_control_field_cb("inv_threshold_hh", lambda: (self.dsp_block.inv_threshold_int&0x00000000FFFFFFFF))
        self.set_control_field_cb("inv_threshold_lh", lambda: (self.dsp_block.inv_threshold_int>>32))
